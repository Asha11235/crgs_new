...
$("document").ready(function(){
	$(".SEARCH").on("change", function() {
		...
		var loadDataContainer = $(currElement.attr("load-data-container-SEARCH"));		
	...
	$(".ADD").on("change", function() {
		var currElement =  $(this);
		console.log("2nd filter clicked..." + currElement.attr("load-data-container-ADD"));
		var loadDataContainer = $(currElement.attr("load-data-container-ADD"));
		loadDataContainer.empty();//to clear data container element
		loadDataContainer.trigger("change");//to clear all child needs a trigger
		var url = currElement.attr("url");
		var firstSelectElement = currElement.find("select:first");
	...
	$(".EDIT").on("change", function() {
		...
		var loadDataContainer = $(currElement.attr("load-data-container-EDIT"));
		loadDataContainer.empty();//to clear data container element
		loadDataContainer.trigger("change");//to clear all child needs a trigger
		var url = currElement.attr("url");
		var firstSelectElement = currElement.find("select:first");
