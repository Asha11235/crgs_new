   function reset(){
	   	$("#notSecure1").empty();$("#notSecure2").empty();$("#notSecure3").empty();
	   	$("#notSecure4").empty();$("#notSecure5").empty();
	   	
	   	$("#food1").empty();$("#food2").empty();$("#food3").empty();
	   	$("#food4").empty();$("#food5").empty();
  	...
  	function drawCircles(data, id){
  		var width = 160, height = 160;
		  var angle = (2 * Math.PI * data) / 100;
	      ...
	      canvas.append("text").text(data + "%").attr("x", 85).attr("y", 85)
