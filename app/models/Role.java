...
/*	*//**return DS role*//*
	public static Role getDSRole() {
		return Role.findByName("DS");
	}
	...
	*//**return M&H role*//*
	public static Role getMHRole() {
		return Role.findByName("M&EH");
	}
	
	*//**return M&C role*//*
	public static Role getMCRole() {
		return Role.findByName("M&EC");
	}
	
	*//**return DM role*//*
	public static Role getDMRole() {
		return Role.findByName("DM");
	}
	*//**return FF role*//*
	public static Role getFFRole() {
		return Role.findByName("FF");
	}
	*//**return RM role*//*
	public static Role getRMRole() {
		return Role.findByName("RM");
	}
	*//**return DO role*//*
	public static Role getDORole() {
		return Role.findByName("DO");
	}*/
